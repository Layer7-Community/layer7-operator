...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayContainerState) DeepCopyInto(out *GatewayContainerState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayContainerState.
func (in *GatewayContainerState) DeepCopy() *GatewayContainerState {
	if in == nil {
		return nil
	}
	out := new(GatewayContainerState)
	in.DeepCopyInto(out)
	return out
}
